...
public enum ErrorCode {
    ...
    //Auth (1000번대)
    INVALID_JWT(HttpStatus.BAD_REQUEST, 1001, "잘못된 JWT 형식입니다."),
    EXPIRED_JWT(HttpStatus.BAD_REQUEST, 1002, "만료된 JWT 토큰입니다."),
    UNSUPPORTED_JWT(HttpStatus.BAD_REQUEST, 1003, "지원되지 않는 JWT 토큰입니다."),
    INVALID_SIGNATURE(HttpStatus.BAD_REQUEST, 1004, "유효하지 않은 서명입니다."),
    MISSING_AUTHORIZATION_JWT(HttpStatus.UNAUTHORIZED, 1005, "인증 토큰이 없습니다."),
    INVALID_BEARER_PREFIX(HttpStatus.BAD_REQUEST, 1006, "Bearer 접두사가 누락되었습니다."),
